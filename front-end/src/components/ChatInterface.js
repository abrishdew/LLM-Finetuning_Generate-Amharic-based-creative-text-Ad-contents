    ...
    <div className="chat-container">
      <header className="chat-header"></header>
      {
        ...
        <div className="chat-message bot-message">
          <p className="initial-message">Hi there! I'm a bot trained to generate amharic Ad </p>
        </div>
      }
      ...
      <form className="chat-input" onSubmit={handleSendMessage}>
        <input
          type="text"
          placeholder="Type your Business text and it will generate an amharic Ad for your Business ..."
          value={inputText}
